...
export declare class SocialMediaStudiosService {
    ...
    addUsers(payload: AddSocialMediaUsersDto, currentUser: any): Promise<ResponseData>;
    createMedia(payload: CreateMediaDto, currentUser: any): Promise<ResponseData>;
    addAttachments(payload: AddFileDto, currentUser: any): Promise<ResponseData>;
    ...
    removeAttachment(payload: RemoveMediaAttachmentDto, currentUser: any): Promise<ResponseData>;
