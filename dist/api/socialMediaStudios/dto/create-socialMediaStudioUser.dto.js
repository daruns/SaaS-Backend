...
exports.CreateSocialMediaStudioUserDto = void 0;
const openapi = require("@nestjs/swagger");
const class_validator_1 = require("class-validator");
class CreateSocialMediaStudioUserDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { userId: { required: true, type: () => Number }, socialMediaStudioId: { required: true, type: () => Number }, canEdit: { required: true, type: () => Boolean }, approved: { required: true, type: () => Boolean }, createdBy: { required: true, type: () => String }, brandCode: { required: true, type: () => String } };
    }
}
__decorate([
