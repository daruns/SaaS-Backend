...
const socialMediaStudio_model_1 = require("../../database/models/socialMediaStudio.model");
const clients_service_1 = require("../clients/clients.service");
const user_model_1 = require("../../database/models/user.model");
const _ = require("lodash");
const app_service_1 = require("../../app/app.service");
const socialMediaStudioUser_model_1 = require("../../database/models/socialMediaStudioUser.model");
const moment = require("moment");
const media_model_1 = require("../../database/models/media.model");
const mediaAttachment_model_1 = require("../../database/models/mediaAttachment.model");
        ...
        if (socialMediaStudio) {
            ...
            if (socialMediaStudio.creatorId === currentUser.id) {
                ...
                try {
                    ...
                    await _.uniq(users).forEach(async (user) => {
                        const usersParams = {
                            userId: user,
