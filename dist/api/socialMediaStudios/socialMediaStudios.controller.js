...
let SocialMediaStudiosController = class SocialMediaStudiosController {
    ...
    async addMediaToSMS(files, media, req) {
...
__decorate([
    ...
    common_1.UseInterceptors(platform_express_1.FilesInterceptor("files", 30)),
    ...
    __metadata("design:returntype", Promise)
], SocialMediaStudiosController.prototype, "addMediaToSMS", null);
__decorate([
