...
const update_serviceItem_dto_1 = require("./dto/update-serviceItem.dto");
const serviceItems_service_1 = require("./serviceItems.service");
const create_serviceItem_dto_1 = require("./dto/create-serviceItem.dto");
...
__decorate([
    common_1.Get(),
    can_decorator_1.Can(subjects_enum_1.Subjects.financeServiceItems, actions_enum_1.Action.Read),
...
__decorate([
    ...
    can_decorator_1.Can(subjects_enum_1.Subjects.financeServiceItems, actions_enum_1.Action.Create),
    openapi.ApiResponse({ status: 201, type: Object }),
    __param(0, common_1.Body()), __param(1, common_1.Request()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [create_serviceItem_dto_1.CreateServiceItemDto, Object]),
    __metadata("design:returntype", Promise)
], ServiceItemsController.prototype, "create", null);
__decorate([
    common_1.Post('update'),
    can_decorator_1.Can(subjects_enum_1.Subjects.financeServiceItems, actions_enum_1.Action.Update),
    openapi.ApiResponse({ status: 201, type: Object }),
    __param(0, common_1.Body()), __param(1, common_1.Request()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [update_serviceItem_dto_1.UpdateServiceItemDto, Object]),
    __metadata("design:returntype", void 0)
], ServiceItemsController.prototype, "update", null);
__decorate([
    common_1.Post('delete'),
    can_decorator_1.Can(subjects_enum_1.Subjects.financeServiceItems, actions_enum_1.Action.Delete),
    openapi.ApiResponse({ status: 201, type: Object }),
    __param(0, common_1.Body()), __param(1, common_1.Request()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", void 0)
], ServiceItemsController.prototype, "deleteById", null);
ServiceItemsController = __decorate([
    common_1.UseGuards(jwt_auth_guard_1.JwtAuthGuard),
    common_1.Controller('serviceItems'),
    __metadata("design:paramtypes", [serviceItems_service_1.ServiceItemsService])
], ServiceItemsController);
exports.ServiceItemsController = ServiceItemsController;
//# sourceMappingURL=serviceItems.controller.js.map