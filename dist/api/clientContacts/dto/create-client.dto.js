...
__decorate([
    ...
    __metadata("design:type", String)
], CreateClientContactDto.prototype, "phoneNumbers", void 0);
__decorate([
    class_validator_1.IsEmail({}, { message: 'Email address is invalid' }),
    __metadata("design:type", String)
], CreateClientContactDto.prototype, "email", void 0);
__decorate([
    class_validator_1.MinLength(0, { message: "rate should start from 0" }),
    class_validator_1.MaxLength(10, { message: "rate should be less than 10" }),
    __metadata("design:type", Number)
], CreateClientContactDto.prototype, "rate", void 0);
