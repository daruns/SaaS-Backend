...
const create_clientContact_user_dto_1 = require("./dto/create-clientContact-user.dto");
let ClientContactsController = class ClientContactsController {
    ...
    async create(clientContact, user, req) {
        const createdClientContact = await this.clientContactsService.create(clientContact, user, req.user);
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_a = typeof create_clientContact_dto_1.CreateClientContactDto !== "undefined" && create_clientContact_dto_1.CreateClientContactDto) === "function" ? _a : Object, create_clientContact_user_dto_1.CreateClientContactUserDto, Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_b = typeof update_clientContact_dto_1.UpdateClientContactDto !== "undefined" && update_clientContact_dto_1.UpdateClientContactDto) === "function" ? _b : Object, Object]),
