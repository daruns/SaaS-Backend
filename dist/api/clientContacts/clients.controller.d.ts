...
import { CreateClientContactUserDto } from './dto/create-clientContact-user.dto';
export declare class ClientContactsController {
    ...
    create(clientContact: CreateClientContactDto, user: CreateClientContactUserDto, req: any): Promise<import("./clientContacts.service").ResponseData>;
